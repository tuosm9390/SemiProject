...
<body>
	...
	<header id="menuheader">
		<a href="<%= request.getContextPath()%>/index.jsp"><img src="<%= request.getContextPath()%>/images/hagong.png"
			style="height: 85px; margin-top: 20px;"></a>
		...
		&nbsp;
		<h3 id="notice">
			<img src="<%= request.getContextPath()%>/images/notice.png" style="height: 30px;">
		</h3>
		<h3 id="sms" onclick="location.href='<%= request.getContextPath()%>/viewAcademy/common/smspage.jsp'">
			<img src="<%= request.getContextPath()%>/images/sms.png" style="height: 30px;">
		</h3>
		<h3 id="calendar">
			<img src="<%= request.getContextPath()%>/images/calendar.png" style="height: 30px;">
		</h3>
		...
		<div id="mid">
			...
			<div class="detailmenu" id="studentdetailmenu">
				<a href="<%= request.getContextPath()%>/viewAcademy/common/studentList.jsp" class="menu1">개인정보</a> <a>|</a> <a
					href="#" class="menu1">수납</a> <a>|</a> <a href="#" class="menu1">상담</a>
				<a>|</a> <a href="#" class="menu1">블랙리스트</a>
			</div>
			<!-- 수업관리 메뉴 -->
			...
			<div class="detailmenu" id="admindetailmenu">
				<a href="#" class="menu4">학원 현황</a> <a>|</a> <a href="#"
					class="menu4">메뉴 권한 관리</a> <a>|</a> <a href="#" class="menu4">연간계획</a>
			</div>
