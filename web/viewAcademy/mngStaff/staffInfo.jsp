		...
		<div class="outArea">
			...
			<table>
				<tr>
					...
					<td width="300px"><input type="text" name="userId" id="userId" value="KJH001205" readonly></td>
					<td width="300px"></td>
				</tr>
				<tr>
					<td>● 이름</td>
				...
				<tr>
					<td></td>
					<td>● 급여 계약서 </td>
					<td colspan="2">20191205_김진호_급여_계약서.hwp　<button class="download">다운로드</button></td>
				</tr>
				<tr>
					<td></td>
					<td>● 경력 등 기타 서류</td>
					<td colspan="2">20191205_김진호_이력서.hwp　<button class="download">다운로드</button></td>
				</tr>
			</table>		
			</form>
