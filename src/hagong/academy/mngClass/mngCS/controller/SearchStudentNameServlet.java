...
/**
 * Servlet implementation class SearchStudentNameServlet
 */
@WebServlet("/srchStu.cs")
public class SearchStudentNameServlet extends HttpServlet {
     ...
     */
    public SearchStudentNameServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<CSStudent> srchStu = new CSService().srchByName(name, clsNo);
